# Makefile for arith40 (Comp 40 Assignment 4)
# 
...
testfun: test_fun.o compress40.o video_pixel.o code_value.o a2blocked.o \
		uarray2.o uarray2b.o a2plain.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

compress40: compress40.o video_pixel.o code_value.o 40image.o a2blocked.o \
			uarray2.o uarray2b.o a2plain.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
